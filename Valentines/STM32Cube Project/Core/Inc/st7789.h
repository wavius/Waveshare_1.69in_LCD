...
/* Pin connection*/
#define ST7789_RST_PORT RST_PIN_GPIO_Port
#define ST7789_RST_PIN  RST_PIN_Pin
#define ST7789_DC_PORT  DC_PIN_GPIO_Port
#define ST7789_DC_PIN   DC_PIN_Pin

#ifndef CFG_NO_CS
#define ST7789_CS_PORT  CS_PIN_GPIO_Port
#define ST7789_CS_PIN   CS_PIN_Pin
#endif

/* If u need Backlight control, uncomment below */
#define BLK_PORT		BL_PIN_GPIO_Port
#define BLK_PIN			BL_PIN_Pin
